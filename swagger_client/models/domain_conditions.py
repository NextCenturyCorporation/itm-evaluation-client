...
class DomainConditions(object):
    ...
    def __init__(self, character_vitals=None, supplies=None):  # noqa: E501
        """DomainConditions - a model defined in Swagger"""  # noqa: E501
    ...
    def character_vitals(self):
        """Gets the character_vitals of this DomainConditions.  # noqa: E501

        True if any of the specified collection of vital values have been met for the specified character_id  # noqa: E501

        :return: The character_vitals of this DomainConditions.  # noqa: E501
    ...
    def character_vitals(self, character_vitals):
        ...
        :type: list[DomainConditionsCharacterVitals]
        """
    ...
    @property
    def supplies(self):
        """Gets the supplies of this DomainConditions.  # noqa: E501

        True if any of the specified supplies reach or go below the specified quantity  # noqa: E501

        :return: The supplies of this DomainConditions.  # noqa: E501
        :rtype: list[Supplies]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DomainConditions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainConditions):
            return False
