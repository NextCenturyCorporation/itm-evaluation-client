...
class KDMAValueParametersInner(BaseModel):
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['intercept', 'medical_weight', 'attr_weight', 'optA', 'optB']):
            raise ValueError("must be one of enum values ('intercept', 'medical_weight', 'attr_weight', 'optA', 'optB')")
        return value
