...
class ProbeConfig(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="A description of the probe for use by TA1")
    __properties: ClassVar[List[str]] = ["probe_id", "description"]
