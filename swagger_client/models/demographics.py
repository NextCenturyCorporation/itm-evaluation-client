...
import six
from swagger_client.models.domain_demographics import DomainDemographics  # noqa: F401,E501

class Demographics(DomainDemographics):
    ...
    if hasattr(DomainDemographics, "swagger_types"):
        swagger_types.update(DomainDemographics.swagger_types)
    ...
    if hasattr(DomainDemographics, "attribute_map"):
        attribute_map.update(DomainDemographics.attribute_map)

    def __init__(self, age=None, sex=None, race=None, role=None, *args, **kwargs):  # noqa: E501
        ...
        if role is not None:
            self.role = role
        DomainDemographics.__init__(self, *args, **kwargs)
