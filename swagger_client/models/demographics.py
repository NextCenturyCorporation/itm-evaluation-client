...
import six
from swagger_client.models.basic_demographics import BasicDemographics  # noqa: F401,E501

class Demographics(BasicDemographics):
    ...
    if hasattr(BasicDemographics, "swagger_types"):
        swagger_types.update(BasicDemographics.swagger_types)
    ...
    if hasattr(BasicDemographics, "attribute_map"):
        attribute_map.update(BasicDemographics.attribute_map)

    def __init__(self, military_disposition=None, military_branch=None, rank=None, rank_title=None, skills=None, mission_importance=None, *args, **kwargs):  # noqa: E501
        ...
        BasicDemographics.__init__(self, *args, **kwargs)
