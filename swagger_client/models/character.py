...
import six
from swagger_client.models.domain_character import DomainCharacter  # noqa: F401,E501

class Character(DomainCharacter):
    ...
    if hasattr(DomainCharacter, "swagger_types"):
        swagger_types.update(DomainCharacter.swagger_types)
    ...
    if hasattr(DomainCharacter, "attribute_map"):
        attribute_map.update(DomainCharacter.attribute_map)

    def __init__(self, id=None, name=None, unstructured=None, demographics=None, rapport=None, unseen=False, *args, **kwargs):  # noqa: E501
        ...
        if unseen is not None:
            self.unseen = unseen
        DomainCharacter.__init__(self, *args, **kwargs)
