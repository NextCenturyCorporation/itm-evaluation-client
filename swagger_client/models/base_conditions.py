...
class BaseConditions(object):
    ...
    def __init__(self, elapsed_time_lt=None, elapsed_time_gt=None, actions=None, probes=None, probe_responses=None):  # noqa: E501
        """BaseConditions - a model defined in Swagger"""  # noqa: E501
    ...
    def elapsed_time_lt(self):
        """Gets the elapsed_time_lt of this BaseConditions.  # noqa: E501

        True if the scenario elapsed time (in seconds) is less than the specified value  # noqa: E501

        :return: The elapsed_time_lt of this BaseConditions.  # noqa: E501
        :rtype: int
        """
    ...
    def elapsed_time_lt(self, elapsed_time_lt):
        """Sets the elapsed_time_lt of this BaseConditions.

        True if the scenario elapsed time (in seconds) is less than the specified value  # noqa: E501

        :param elapsed_time_lt: The elapsed_time_lt of this BaseConditions.  # noqa: E501
        :type: int
        """
    ...
    def elapsed_time_gt(self):
        """Gets the elapsed_time_gt of this BaseConditions.  # noqa: E501

        True if the scenario elapsed time (in seconds) is greater than the specified value  # noqa: E501

        :return: The elapsed_time_gt of this BaseConditions.  # noqa: E501
        :rtype: int
        """
    ...
    def elapsed_time_gt(self, elapsed_time_gt):
        """Sets the elapsed_time_gt of this BaseConditions.

        True if the scenario elapsed time (in seconds) is greater than the specified value  # noqa: E501

        :param elapsed_time_gt: The elapsed_time_gt of this BaseConditions.  # noqa: E501
        :type: int
        """
    ...
    @property
    def actions(self):
        """Gets the actions of this BaseConditions.  # noqa: E501
        ...
        :return: The actions of this BaseConditions.  # noqa: E501
        :rtype: list[list[str]]
        """
    ...
    def actions(self, actions):
        """Sets the actions of this BaseConditions.

        True if any of the specified lists of actions have been taken; multiple action ID lists have \"or\" semantics; multiple action IDs within a list have \"and\" semantics  # noqa: E501

        :param actions: The actions of this BaseConditions.  # noqa: E501
        :type: list[list[str]]
        """
    ...
    @property
    def probes(self):
        """Gets the probes of this BaseConditions.  # noqa: E501

        True if the specified list of probe_ids have been answered  # noqa: E501

        :return: The probes of this BaseConditions.  # noqa: E501
        :rtype: list[str]
        """
        return self._probes
    ...
    def probes(self, probes):
        """Sets the probes of this BaseConditions.

        True if the specified list of probe_ids have been answered  # noqa: E501

        :param probes: The probes of this BaseConditions.  # noqa: E501
        :type: list[str]
        """
    ...
    def probe_responses(self):
        """Gets the probe_responses of this BaseConditions.  # noqa: E501

        True if the specified list of probe responses (choice) have been sent  # noqa: E501

        :return: The probe_responses of this BaseConditions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def probe_responses(self, probe_responses):
        """Sets the probe_responses of this BaseConditions.

        True if the specified list of probe responses (choice) have been sent  # noqa: E501

        :param probe_responses: The probe_responses of this BaseConditions.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BaseConditions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseConditions):
            return False
