...
class BasicConditions(object):
    ...
    def __init__(self, elapsed_time_lt=None, elapsed_time_gt=None, actions=None, probes=None, probe_responses=None):  # noqa: E501
        """BasicConditions - a model defined in Swagger"""  # noqa: E501
    ...
    def elapsed_time_lt(self):
        """Gets the elapsed_time_lt of this BasicConditions.  # noqa: E501

        True if the scenario elapsed time (in seconds) is less than the specified value  # noqa: E501

        :return: The elapsed_time_lt of this BasicConditions.  # noqa: E501
        :rtype: int
        """
    ...
    def elapsed_time_gt(self):
        """Gets the elapsed_time_gt of this BasicConditions.  # noqa: E501

        True if the scenario elapsed time (in seconds) is greater than the specified value  # noqa: E501

        :return: The elapsed_time_gt of this BasicConditions.  # noqa: E501
        :rtype: int
        """
    ...
    @property
    def actions(self):
        """Gets the actions of this BasicConditions.  # noqa: E501
        ...
        :return: The actions of this BasicConditions.  # noqa: E501
        :rtype: list[list[str]]
        """
    ...
    @property
    def probes(self):
        """Gets the probes of this BasicConditions.  # noqa: E501

        True if the specified list of probe_ids have been answered  # noqa: E501

        :return: The probes of this BasicConditions.  # noqa: E501
        :rtype: list[str]
        """
        return self._probes
    ...
    def probe_responses(self):
        """Gets the probe_responses of this BasicConditions.  # noqa: E501

        True if the specified list of probe responses (choice) have been sent  # noqa: E501

        :return: The probe_responses of this BasicConditions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BasicConditions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BasicConditions):
            return False
