...
class ProbeOption(object):
    ...
    def __init__(self, id=None, value=None, assoc_action=None, kdma_association=None):  # noqa: E501
        """ProbeOption - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._value = None
        self._assoc_action = None
        self._kdma_association = None
        self.discriminator = None
        self.id = id
        self.value = value
        if assoc_action is not None:
            self.assoc_action = assoc_action
    ...
    @property
    def assoc_action(self):
        """Gets the assoc_action of this ProbeOption.  # noqa: E501


        :return: The assoc_action of this ProbeOption.  # noqa: E501
        :rtype: Action
        """
        return self._assoc_action

    @assoc_action.setter
    def assoc_action(self, assoc_action):
        """Sets the assoc_action of this ProbeOption.


        :param assoc_action: The assoc_action of this ProbeOption.  # noqa: E501
        :type: Action
        """

        self._assoc_action = assoc_action
