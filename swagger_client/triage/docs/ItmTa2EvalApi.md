# swagger_client.triage.ItmTa2EvalApi
...
```python
import swagger_client.triage
from swagger_client.triage.models.alignment_target import AlignmentTarget
from swagger_client.triage.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = swagger_client.triage.Configuration(
    host = "http://localhost"
)


# Enter a context with an instance of the API client
with swagger_client.triage.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = swagger_client.triage.ItmTa2EvalApi(api_client)
...
with swagger_client.triage.ApiClient(configuration) as api_client:
    ...
    api_instance = swagger_client.triage.ItmTa2EvalApi(api_client)
    session_id = 'session_id_example' # str | a unique session_id, as returned by /ta2/startSession
    action = swagger_client.triage.Action() # Action | Encapsulation of the intended action by a DM in the context of the scenario (optional)
...
with swagger_client.triage.ApiClient(configuration) as api_client:
    ...
    api_instance = swagger_client.triage.ItmTa2EvalApi(api_client)
    session_id = 'session_id_example' # str | a unique session_id, as returned by /ta2/startSession
    action = swagger_client.triage.Action() # Action | Encapsulation of an action taken by a DM in the context of the scenario (optional)
...
with swagger_client.triage.ApiClient(configuration) as api_client:
    ...
    api_instance = swagger_client.triage.ItmTa2EvalApi(api_client)
    session_id = 'session_id_example' # str | a unique session_id, as returned by /ta2/startSession
    action = swagger_client.triage.Action() # Action | Encapsulation of an action to be validated by a DM in the context of the scenario (optional)
