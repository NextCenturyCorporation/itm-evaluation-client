...
class Scene(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "state", "next_scene", "end_scene_allowed", "persist_characters", "removed_characters", "probe_config", "action_mapping", "restricted_actions", "transition_semantics", "transitions"]
