    ...
    def make_instance(self, include_optional) -> Scenario:
        ...
        if include_optional:
            return Scenario(
                ...
                state = swagger_client.triage.models.state.State(),
                scenes = [
                    swagger_client.triage.models.scene.Scene(
                        id = '', 
                        state = swagger_client.triage.models.state.State(), 
                        next_scene = '', 
                        ...
                        probe_config = [
                            swagger_client.triage.models.probe_config.ProbeConfig(
                                probe_id = '', 
                                description = '', )
                            ], 
                        action_mapping = [
                            swagger_client.triage.models.action_mapping.ActionMapping(
                                action_id = 'action_01', 
                                ...
                                action_conditions = swagger_client.triage.models.conditions.Conditions(), 
                                probe_condition_semantics = 'and', 
                                probe_conditions = swagger_client.triage.models.conditions.Conditions(), )
                            ], 
                        restricted_actions = ["SEARCH"], 
                        transition_semantics = 'and', 
                        transitions = swagger_client.triage.models.conditions.Conditions(), )
                    ]
            )
        else:
            return Scenario(
