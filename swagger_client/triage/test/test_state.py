...
class TestState(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> State:
        ...
        if include_optional:
            return State(
                mission = swagger_client.triage.models.mission.Mission(
                ...
                environment = swagger_client.triage.models.environment.Environment(
                    sim_environment = swagger_client.triage.models.sim_environment.SimEnvironment(
                        ...
                        noise_ambient = 'none', 
                        noise_peak = 'none', ), 
                    decision_environment = swagger_client.triage.models.decision_environment.DecisionEnvironment(
                        unstructured = 'Injuries triggered by an IED detonation.  Helicopter Evac expected in one hour for up to three casualties.', 
                        aid = [
                            swagger_client.triage.models.aid.Aid(
                                id = '', 
                                delay = 0, 
                                role = 1, 
                                patients_treated = [
                ...
                unstructured = '',
                elapsed_time = 10,
                meta_info = swagger_client.triage.models.meta_info.MetaInfo(
                    scene_id = '', 
                    probe_response = swagger_client.triage.models.probe_response.ProbeResponse(
                        scenario_id = '', 
                        probe_id = '', 
                        choice = '', 
                        justification = '', ), ),
                events = [
                    swagger_client.triage.models.event.Event(
                        unstructured = '', 
                        type = 'change', 
                        source = '', 
                        object = '', 
                ...
                characters = [
                    swagger_client.triage.models.character.Character()
                    ],
