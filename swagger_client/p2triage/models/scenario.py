...
class Scenario(BaseModel):
    ...
    alt_id: Optional[StrictStr] = Field(default=None, description="an alternate unique id for the scenario; there is a 1-to-1 mapping from id to alt_id")
    alt_name: Optional[StrictStr] = Field(default=None, description="an alternate name for the scenario; there is a 1-to-1 mapping from name to alt_name")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "alt_id", "alt_name", "first_scene", "session_complete", "state", "scenes"]
