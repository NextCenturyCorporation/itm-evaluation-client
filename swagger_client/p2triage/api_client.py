...
from swagger_client.p2triage.api_response import ApiResponse, T as ApiResponseT
import swagger_client.p2triage.models
from swagger_client.p2triage import rest
from swagger_client.p2triage.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(swagger_client.p2triage.models, klass)
