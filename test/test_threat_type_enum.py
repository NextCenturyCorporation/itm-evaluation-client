...
class TestThreatTypeEnum(unittest.TestCase):
    """ThreatTypeEnum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreatTypeEnum:
        """Test ThreatTypeEnum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreatTypeEnum`
        """
        model = ThreatTypeEnum()
        if include_optional:
            return ThreatTypeEnum(
            )
        else:
            return ThreatTypeEnum(
        )
